...
public class Folder {
	...
	public Folder(int name, File file, boolean rec) throws IOException {
		...
		if (!rec) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "请删除此文件夹下的\"myFileSystem\"后重新运行此程序！！", "Error",
	...
	public boolean deleteFile(File file, double capacity) {
		if (file.getName().equals("1") || file.getName().equals("2") || file.getName().equals("3")
				|| file.getName().equals("4") || file.getName().equals("5") || file.getName().equals("6")
				|| file.getName().equals("7") || file.getName().equals("8") || file.getName().equals("9")
				|| file.getName().equals("1BitMap&&Fat.txt") || file.getName().equals("2BitMap&&Fat.txt")
				|| file.getName().equals("3BitMap&&Fat.txt") || file.getName().equals("4BitMap&&Fat.txt")
				|| file.getName().equals("5BitMap&&Fat.txt") || file.getName().equals("5BitMap&&Fat.txt")
				|| file.getName().equals("6BitMap&&Fat.txt") || file.getName().equals("7BitMap&&Fat.txt")
				|| file.getName().equals("8BitMap&&Fat.txt") || file.getName().equals("9BitMap&&Fat.txt")
				|| file.getName().equals("recover.txt")) {
			JOptionPane.showMessageDialog(null, "该文件夹受保护!!", "Access fail", JOptionPane.ERROR_MESSAGE);
			return false;
		}
